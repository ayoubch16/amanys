                                                ...
                                                <table class="table">
                                                    <thead>
                                                        <tr>
                                                            ...
                                                            <th class="text-left">Quantité/Couleur</th>
...
$sql="SELECT * FROM `commandes` $txt  ORDER BY `dateCmd` DESC ";$result=$cnx->query($sql);while($row=$result->fetch_assoc()){$reffid=$row['ReffClient'];$sql1="SELECT * FROM `clients` WHERE `Reff`='$reffid' ";$result1=$cnx->query($sql1);if($row1=$result1->fetch_assoc()){} ?>
                                                        <tr>
                                                            ...
                                                            <td class="text-left">
                                                                <?php 
                                                                    $txtRef  =$row['ReffProd'];
                                                                    $TableRef = explode("-", $txtRef);
                                                                    for($i=0;$i<count($TableRef)-1;$i++){
                                                                            echo $TableRef[$i].'<br>';
                                                                    }                     
                                                                ?>
                                                            </td>
                                                            <td class="text-left">
                                                                <?php 
                                                                    $txtTaille  =$row['tailleProd'];
                                                                    $TableTaille = explode("-", $txtTaille);
                                                                    for($i=0;$i<count($TableRef)-1;$i++){
                                                                            echo $TableTaille[$i].'<br>';
                                                                    }                     
                                                                ?>
                                                            </td>
                                                            <td class="text-left">
                                                                <?php 
                                                                    $txtQnt  =$row['QntProd'];
                                                                    $TableQnt = explode("-", $txtQnt);
                                                                    $txtColor  =$row['colorProd'];
                                                                    $TableColor = explode("-", $txtColor); 
                                                                    for($i=0;$i<count($TableRef)-1;$i++){
                                                                            echo '<div style="display:flex;justify-content: space-between;align-items: center;">'; 
                                                                            echo $TableQnt[$i].'<br>';
                                                                            echo '<p style="margin: 0 !important;;width: 15px;height: 15px;background-color: '.$TableColor[$i].';border-radius: 0%;"></p><br>';
                                                                            echo '</div>';
                                                                    }                     
                                                                ?>
                                                            </td>
