...
<body>
    ...
    input[type="checkbox"]#pointure22:checked+label,
    ...
    input[type="checkbox"]#tailleV11:checked+label,
    ...
    input[type="checkbox"]#tailleA16:checked+label {
        color: #000;
        background-color: #e1d106;
        border-radius: 3px
    }
                                                    ...
                                                    <div class="row">
                                                        <div id="Taillechaussure" class="col-sm">
                                                            ...
                                                            <input type="checkbox" name="chkl[ ]" value="ST"
                                                                class="pointure" id="pointure22">
                                                            <label class="labelponture" for="pointure22">Standard</label>
                                                        </div>
                                                        <div id="Taillevetement" class="col-sm">
                                                            ...
                                                            <input type="checkbox" name="chkl[ ]" value="ST"
                                                                class="tailleV" id="tailleV11">
                                                            <label for="tailleV11">Standard</label>
                                                        ...
                                                        <div id="Tailleaccessoires" class="col-sm">
                                                            ...
                                                            <label for="tailleA15">70</label>
                                                            <input type="checkbox" name="chkl[ ]" value="ST"
                                                                class="tailleA" id="tailleA16">
                                                            <label for="tailleA16">Standard</label>
