        ...
        <div id="panier1" class="flex-container">
            <form method="POST" action="authen.php">
                ...
                <div class="flex-item my-2">
                    <p style="font-size:10px;text-align:left">Adresse Email</p><input class="form-input" type="email" required name="email" placeholder="">
                </div>
                <div class="flex-item my-2">
                    <p style="font-size:10px;text-align:left">Mot de passe</p><input class="form-input" type="password" required name="mdp" placeholder="">
                </div>
