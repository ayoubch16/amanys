											...
											<div class="card-body">
												<div class="row">
													...
													<div class="col-sm">
														...
														?>
														<h6 style="font-size: 10px;">Commande</h6>
									...
									<table style="width:100%">
										...
										?>
											<tr>
												...
												<td><?php echo $row['quantitevendu']; ?></td>
		...
		const myChart2 = new Chart(ctx2, {
			...
			data: {
				...
				datasets: [{
					...
					backgroundColor: ["#111C2A", "#111C2A", "#111C2A", "#111C2A", "#111C2A", "#111C2A", "#111C2A", "#111C2A", "#111C2A", "#111C2A", "#111C2A", "#111C2A"]
				}]
			},
			options: {
				scales: {
